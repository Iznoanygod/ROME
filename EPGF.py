...
parser = argparse.ArgumentParser(description='EPGF sequence generator')
parser.add_argument('--output_file', '-o', type=str, default='./output.fasta', help='Path to write generated FASTA output')
parser.add_argument('--superfamily', '-s', type=str, required=True, help='Protein Superfamily')
...
with torch.no_grad():
    i = 0
    #gennerate 16 protein sequences
    while i < 128:
